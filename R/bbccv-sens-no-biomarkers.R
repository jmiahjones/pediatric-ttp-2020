...
cluster.file <- "./cluster-sens-no-biomarkers.log"
trained.model.file <- "./results/trained-models-sens-no-biomarkers.RData"
feature.importance.file <- "./results/feature_importance_sens_no_biomarkers.csv"
oos.prediction.file <- "./results/trained-model-predictions-sens-no-biomarkers.RData"
boot.res.file <- "./results/results-bbccv-sens-no-biomarkers.RData"
boot.ci.csv <- "./results/ci-sens-no-biomarkers.csv"
